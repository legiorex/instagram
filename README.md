...
12. Перейди в браузер и открой страничку [http://localhost:3000](http://localhost:3000/). Когда страничка загрузится, сообщение «Добро пожаловать на воркшоп по React»;
...
> Заметка: команды ниже станут доступны после первого выполнения команды `yo @lectrum/ui`.\
